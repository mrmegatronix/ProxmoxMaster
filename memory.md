# Agent Memory Bank: ProxmoxMaster

> Persistent knowledge, architecture, patterns, and decisions synced via `agent-memory-mcp`.

## 1. Project Overview & Architecture
- **Repository**: `ProxmoxMaster`
- **Type**: Proxmox Management / Infrastructure
- **Tech Stack**: HTML5, JavaScript, CSS3
- **Entry Points**: Root directory files
- **Description**: Central repository for Proxmox configuration scripts, LXC service installation scripts, etc.
